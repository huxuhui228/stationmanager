...
class district(models.Model):
    district = models.CharField(max_length=32, default='', null=True, blank=True)
    class Meta:
...
class measure_means(models.Model):
    means = models.CharField(max_length=32, default='', null=True, blank=True)
...
class station(models.Model):
    ...
    name_cn = models.CharField(max_length=64,default='',null=True,blank=True)
...
#                                     default='测震',null=True,blank=True)    
    project_source = models.CharField(max_length=32,null=True,blank=True,
...
#    district = models.CharField(max_length=32,choices=DISTRICT_CHOICE,default='济南')
    ...
    lithology = models.CharField(max_length=32,default='',null=True,blank=True)
...
class equip_manu(models.Model):
    ...
    staff_name = models.CharField(max_length=32,null=True,blank=True)
    address = models.CharField(max_length=128,null=True,blank=True)
    phone = models.CharField(max_length=128,null=True,blank=True)
    mobile_phone = models.CharField(max_length=128,null=True,blank=True)
    emai_address = models.EmailField(max_length=128,null=True,blank=True)
    note = models.TextField(max_length=256,default='',null=True,blank=True)
...
class equipment(models.Model):
    ...
    serial_num = models.CharField(max_length=64,null=True,blank=True)
    note = models.TextField(max_length=256,default='',null=True,blank=True)
...
#    station = models.CharField(max_length=64,verbose_name='台站')
    ...
    staff = models.CharField(max_length=32,null=True,blank=True,verbose_name='处理人员')
    maintain_process = models.TextField(max_length=256,default='',null=True,blank=True,verbose_name='处理经过')
    note = models.TextField(max_length=256,default='',null=True,blank=True,verbose_name='备注')
...
class equip_maintain_record(models.Model):
    ...
    staff = models.CharField(max_length=32,null=True,blank=True)
    note = models.TextField(max_length=256,default='',null=True,blank=True)
...
class equip_delivery_record(models.Model):
    ...
    serial_num = models.CharField(max_length=64,null=True,blank=True,verbose_name="序列号")
    ...
    sender = models.CharField(max_length=32,choices=SENDER_CHOICES,null=True,blank=True,verbose_name="发件人")
    receiver_unit = models.CharField(max_length=32,null=True,blank=True,verbose_name="收件单位")
    receiver = models.CharField(max_length=32,null=True,blank=True,verbose_name="收件人")
    back_status = models.CharField(max_length=32,choices=BACK_STATUS,default='未返回',null=True,blank=True,verbose_name="返回状态")
    ...
    back_serial_num = models.CharField(max_length=64,null=True,blank=True,verbose_name="寄回序列号")
    back_unit = models.CharField(max_length=32,null=True,blank=True,verbose_name="寄回单位")
    back_sender = models.CharField(max_length=32,null=True,blank=True,verbose_name="寄回人")
    back_receiver = models.CharField(max_length=32,choices=SENDER_CHOICES,null=True,blank=True,verbose_name="寄回接收人")
...
class equip_status(models.Model):
    ...
    sampling_rate = models.CharField(max_length=32,choices=SAMPLING_RATE_CHOICE,null=True,blank=True)
    transmission_type = models.CharField(max_length=32,choices=TRANSMISSION_TYPE_CHOICE,null=True,blank=True)
...
class schedule(models.Model):
    ...
    staff = models.CharField(max_length=32,null=True,blank=True,default='胡旭辉',verbose_name='人员')
    plan = models.TextField(max_length=256,null=True,blank=True,verbose_name='计划内容')
    status = models.CharField(max_length=32,choices=SCHEDULE_status_CHOICE,default='1',null=True,blank=True,verbose_name="完成状态")
